    ...
    var body: some View {
        List {
            Section {
                ...
                Text("Apple On-Device Voice (Default)")
            } footer: {
                Text("Every guide can be narrated with the English voice built into iOS. Audio stays on this device and does not depend on the Kokoro download.")
            }
    ...
    var body: some View {
        List {
            Section {
                ...
                Text("Kokoro Neural Voice (Optional)")
            } footer: {
				Text("Kokoro is an optional higher-quality voice pack. A failed Kokoro download no longer prevents narration.")
            }
            ...
            Section {
                ...
                Text("Playback speed applies to saved narration generated by the built-in Apple voice or an optional narration provider.")
            }
            ...
            Section {
                ...
                Text("When on, narration starts after a guide finishes. The built-in Apple voice requires no model download.")
            }
        }
