...
struct InsightAtlasPromptGenerator {
    ...
    static func generatePrompt(
        ...
        **Exercises** - Use varied types:
        ...
        Use visuals to clarify relationships, processes, and comparisons that prose alone cannot efficiently convey. Available visual tags (use exact names): VISUAL_TIMELINE, VISUAL_FLOWCHART, VISUAL_COMPARISON_MATRIX, VISUAL_TABLE, VISUAL_CONCEPT_MAP, VISUAL_RADAR, VISUAL_HIERARCHY, VISUAL_NETWORK, VISUAL_BAR_CHART, VISUAL_QUADRANT, VISUAL_PIE_CHART, VISUAL_LINE_CHART, VISUAL_AREA_CHART, VISUAL_SCATTER_PLOT, VISUAL_VENN, VISUAL_GANTT, VISUAL_FUNNEL, VISUAL_PYRAMID, VISUAL_CYCLE, VISUAL_FISHBONE, VISUAL_SWOT, VISUAL_SANKEY, VISUAL_TREEMAP, VISUAL_HEATMAP, VISUAL_BUBBLE, VISUAL_INFOGRAPHIC, VISUAL_STORYBOARD, VISUAL_JOURNEY_MAP, VISUAL_BAR_CHART_STACKED, VISUAL_BAR_CHART_GROUPED, VISUAL_GENERIC.
        ...
        - Use the full visual library (31 supported visual types) across guides to avoid repetition.
